...
struct FillingData {
    static let data: [ContentType] = [
        ...
        .gallery(Gallery(coverImage: .init("el-0"), title: "Elephants", images: .init(base: "el", count: 4))),
        .gallery(Gallery(coverImage: .init("freedom-0"), title: "Август 2020", images: .init(base: "freedom", count: 7)))
